    ...
    },
    {
        ...
        inputSchema: {
            ...
            properties: {
                ...
                group: {
                    type: "boolean",
                    description: "Whether grouping is enabled. When enabled, column charts require a 'group' field in the data.",
                },
                stack: {
                    type: "boolean",
                    description: "Whether stacking is enabled. When enabled, column charts require a 'group' field in the data.",
                },
                ...BaseConfig,
            },
            required: ["data"],
    ...
    },
    {
        ...
        inputSchema: {
            ...
            properties: {
                ...
                innerRadius: {
                    type: "number",
                    description: "Set the pie chart as a donut chart. Set the value to 0.6 to enable it.",
                    default: 0,
                },
                ...BaseConfig,
            },
        ...
        inputSchema: {
            ...
            properties: {
                data: {
                    ...
                    description: "Data for pie chart, such as, [{ time: '2018', value: 99.9 }].",
                },
                stack: {
                    type: "boolean",
    ...
    },
    {
        ...
        inputSchema: {
            ...
            properties: {
                ...
                group: {
                    type: "boolean",
                    description: "Whether grouping is enabled. When enabled, bar charts require a 'group' field in the data.",
                },
                stack: {
                    type: "boolean",
 ...
 */
async function generateChartUrl(type, options) {
